...
const players = [
  ...
  { name: "Juniòór", merits: 11, fractions: 0 },
  ...
  { name: "Lilyuzumi", merits: 16, fractions: 5 },
  ...
  { name: "Sprout", merits: 8, fractions: 0 },
  { name: "Sr. White :)", merits: 5, fractions: 3 },
